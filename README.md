...
# 製作背景
我が家は薪ストーブユーザーであり、近隣にも薪ストーブユーザーが多いです。
薪ストーブの火は柔らかく、体の芯から暖めてくれる優れた暖房器具ですが、持ち山がないユーザーは薪の調達には苦労します。一方、持ち山の倒木、庭の剪定木等の廃材の処理に困っている人たちもいます。薪の調達に苦労している薪ストーブユーザーが、そんな廃材を薪として調達できる場があれば良いなと思いこのアプリを製作しました。
...
# 使用方法
### ユーザー登録  
1. トップ画面、ヘッダー右側の「ユーザー登録」をクリック

### ユーザーログイン
1. トップ画面、ヘッダー右側の「ログイン」をクリック  

### マイメニュー
1. ユーザーログインする  
2. トップ画面、ヘッダー右側に表示されるユーザー名にカーソルを合わせる
3. ユーザーメニューが表示されるので「マイメニュー」をクリック


### 記事投稿  
1. ユーザー登録またはユーザーログインをする 
2. トップ画面右下にある「新規投稿」ボタンをクリック、またはマイメニューから「新規投稿」をクリック
...
# こだわったところ
### タグ登録,検索時のサジェスト機能  
新規投稿、タグ検索する際にタグ名を入力する度に関連性のあるタグ名を表示します。
